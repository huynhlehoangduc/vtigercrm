<?php /* Smarty version Smarty-3.1.7, created on 2020-10-15 17:21:45
         compiled from "D:\Work\projects\vtigercrm\includes\runtime/../../layouts/v7\modules\Documents\partials\SidebarEssentials.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11518146505f88852980b007-74691854%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6d873e7f5268641d60a18415239e1796fff74591' => 
    array (
      0 => 'D:\\Work\\projects\\vtigercrm\\includes\\runtime/../../layouts/v7\\modules\\Documents\\partials\\SidebarEssentials.tpl',
      1 => 1602587794,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11518146505f88852980b007-74691854',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5f888529cb133',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5f888529cb133')) {function content_5f888529cb133($_smarty_tpl) {?>
...
"><?php ob_start();?><?php echo strlen($_smarty_tpl->tpl_vars['VIEWNAME']->value);?>
<?php $_tmp2=ob_get_clean();?><?php if ($_tmp2>40){?> <?php echo htmlspecialchars(substr($_smarty_tpl->tpl_vars['VIEWNAME']->value,0,40), ENT_QUOTES, 'UTF-8', true);?>
...
<?php $_tmp3=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['FOLDERNAME'] = new Smarty_variable($_tmp3, null, 0);?> 
                        <li style="font-size:12px;" class='documentFolder <?php if ($_smarty_tpl->tpl_vars['FOLDER_VALUE']->value==$_smarty_tpl->tpl_vars['FOLDER']->value->getName()){?> active<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['folderView']['iteration']>5){?> filterHidden hide<?php }?>'>
...
">
                                ...
                                <span class="foldername"><?php ob_start();?><?php echo strlen($_smarty_tpl->tpl_vars['FOLDERNAME']->value);?>
<?php $_tmp4=ob_get_clean();?><?php if ($_tmp4>40){?> <?php echo htmlspecialchars(substr($_smarty_tpl->tpl_vars['FOLDERNAME']->value,0,40), ENT_QUOTES, 'UTF-8', true);?>
...
">
 ...
 ... 
		...
		<div class='clearfix'> 
                	<a class="toggleFilterSize" data-more-text="Show more" data-less-text="Show less"> 
	                       	<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['folderView']['iteration']>5){?>
        	                	<?php echo vtranslate('LBL_SHOW_MORE','Vtiger');?>
